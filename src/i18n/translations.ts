...
export const translations = {
  fr: {
    ...
    'home.mudpark.intro': 'Le 30 mai 2026, la base devient le terrain de jeu de Mud Park : 24 obstacles, 4 ou 8 km dans la boue, dans le cadre UNESCO du lac. Et la terrasse en est le QG.',
    'home.mudpark.body': 'Course à obstacles accessible de 7 à 77 ans, en famille, entre amis ou en équipe. Pas de chrono, pas de podium : juste un parcours à traverser ensemble, à son rythme, entre pinède, plage et cascades. Cette année, départ et arrivée se font ici, sur la terrasse — du café d\'avant-course à l\'apéro coucher de soleil, vue lac comprise.',
  ...
  en: {
    ...
    'home.mudpark.intro': 'On May 30, 2026, the base becomes the playground of Mud Park: 24 obstacles, 4 or 8 km through the mud, in the UNESCO-listed setting of the lake. And the terrace is race-day HQ.',
    'home.mudpark.body': 'Obstacle course open to every age from 7 to 77, families, friends or crews. No clock, no podium: just a course to cross together, at your own pace, between pine forest, beach and waterfalls. This year, start and finish both happen right here on the terrace — from the pre-race coffee to the sunset apéro, with the lake in full view.',
  ...
  es: {
    ...
    'home.mudpark.intro': 'El 30 de mayo de 2026, la base se transforma en el escenario de Mud Park: 24 obstáculos, 4 u 8 km a través del barro, en el entorno UNESCO del lago. Y la terraza será el cuartel general.',
    'home.mudpark.body': 'Carrera de obstáculos abierta de 7 a 77 años, en familia, entre amigos o por equipos. Sin cronómetro, sin podio: solo un recorrido para cruzar juntos, a tu ritmo, entre pinar, playa y cascadas. Este año, la salida y la llegada se hacen aquí mismo, en la terraza — del café antes de la carrera al aperitivo al atardecer, con vistas al lago incluidas.',
